...
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('3日の努力', '総運動記録日数が3日になった。', 3, 30, 2, 1);
insert into achievement
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('10日の努力', '総運動記録日数が10日になった。', 10, 100, 2, 1);
insert into achievement
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('100日の努力', '総運動記録日数が100日になった。', 100, 1000, 2, 1);
insert into achievement
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('3日生存', '総食事記録日数が3日になった', 3, 30, 1, 1);
insert into achievement
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('10日生存', '総食事記録日数が10日になった', 10, 100, 1, 1);
insert into achievement
(achievement_name, requirement_to_get, condition_formula, score, major_divisions, sub_divisions)
values
('100日生存', '総食事記録日数が100日になった', 100, 1000, 1, 1);
...
insert into lists_and_records
(category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(2,1,'肉', 1000,1,null,null,'2022-06-18', 1);
insert into lists_and_records
(category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(2,1,'差かな', 1000,1,null,null,'2022-07-18', 1);
insert into lists_and_records
(category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(2,1,'おいしい', 300,1,null,null,'2022-08-01', 1);

insert into lists_and_records
(lists_and_records_id, category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(17,2,1, '唐揚げ', 500,1,null,null,'2022-06-20', 1);
...
insert into lists_and_records
(lists_and_records_id, category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(15,2,5, null, 60, 23, null, null,'2022-06-18', 1);
insert into lists_and_records
(lists_and_records_id, category, type, value1, value2, value3, value4, value5, create_date, user_id)
values(16,2,5, null, 50, 23, null, null,'2022-06-18', 2);
